...
REMOTE_PATH = '/MYSG'
FILENAME = 'UniCustomerList.csv'



def run_sqlplus_script_from_file(script_filename="UniCustomerList.txt"):
    """
...
if __name__ == "__main__":
    run_sqlplus_script_from_file(r"C:\Users\USER\PycharmProjects\EmailOracle\UniCustomerList.txt")
    current_date_str = datetime.now().strftime('%y%m%d')

    with open(r"C:\Unisales\UniCustomerList.csv", 'r') as f:
