...
# --- Configuration ---
HOSTNAME = 'bizlink.ufs-armstrong.com'
USERNAME = 'lsh'
PASSWORD = 'yK.wVpLsH_nj21zj'  # WARNING: Hardcoded password for example only.
LOCAL_PATH = r'C:\Unisales'
REMOTE_PATH = '/uploads'
FILENAME = 'Unisales.csv'
...
if __name__ == "__main__":
    run_sqlplus_script_from_file(r"C:\Users\USER\PycharmProjects\EmailOracle\Unisales.txt")
    current_date_str = datetime.now().strftime('%y%m%d')

    excel_filepath = f"C:\\UNISALES\\Unisales.csv"
