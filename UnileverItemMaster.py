...
REMOTE_PATH = '/MYSG'
FILENAME = 'UniItemMaster.csv'



def run_sqlplus_script_from_file(script_filename="UniItemMaster.txt"):
    """
...
if __name__ == "__main__":
    run_sqlplus_script_from_file(r"C:\Users\USER\PycharmProjects\EmailOracle\UniItemMaster.txt")
